...
<c:forEach items="${topQuickHeroes}" var="hero">
    <div>
        <div class="progress" data-toggle="collapse" data-target="#collapseQuick${hero.heroClass}" data-parent="#accordion">
        ...
        <div id="collapseQuick${hero.heroClass}" class="panel-collapse collapse">
    ...
    <hr class="divider">
    <script>
        quickHours.push(${hero.hours});
        quickHeroes.push("${hero.heroClass}");
    </script>
</c:forEach>